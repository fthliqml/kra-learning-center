        ...
        <div class="flex gap-3 flex-col w-full items-center justify-center lg:justify-end md:gap-2 md:flex-row flex-1">
            ...
            <div class="flex items-center gap-2">
                <x-select wire:model.live="filterStatus" :options="$statusOptions" option-value="value" option-label="label"
                    placeholder="All" class="!w-fit !h-10 focus-within:border-0 cursor-pointer"
                    icon-right="o-funnel" />
                <x-select wire:model.live="filterGroup" :options="$groupOptions" option-value="value" option-label="label"
                    placeholder="All Groups" class="!w-fit !h-10 focus-within:border-0 cursor-pointer"
                    icon-right="o-tag" />
            </div>
