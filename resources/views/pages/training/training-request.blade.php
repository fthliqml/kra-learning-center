<div>
    ...
    {{-- Skeleton Loading --}}
    <x-skeletons.table :columns="6" :rows="10" targets="search,filter,openCreateModal,approve,reject" />

    {{-- No Data State --}}
    @if ($requests->isEmpty())
        <div wire:loading.remove wire:target="search,filter,openCreateModal,approve,reject"
