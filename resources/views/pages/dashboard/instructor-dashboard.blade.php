                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ $totalParticipants }}
                                <span class="text-base font-normal text-gray-400">participants</span>
                            </p>
                        </div>
                        <div class="p-3 bg-secondary rounded-xl">
                    ...
                    <div class="mt-3 flex items-center text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <span>Across all your trainings</span>
                    </div>
                </div>
            </div>
