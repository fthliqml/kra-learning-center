<div class="space-y-4">
    <div class="grid grid-cols-1 gap-4">
        ...
        <x-choices label="Level*" :options="[['value' => 1, 'label' => 'Level 1'], ['value' => 3, 'label' => 'Level 3']]" option-value="value" option-label="label" class="w-52"
            wire:model.defer="templateLevel" single />
    </div>
    <div class="flex justify-end">
        <x-ui.button type="button" class="mt-5" variant="primary" wire:click="saveTemplateInfo"
            wire:loading.attr="disabled" wire:target="saveTemplateInfo">
