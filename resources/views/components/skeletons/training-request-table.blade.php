<div wire:loading wire:target="search,filter,openCreateModal,approve,reject" class="w-full p-4 overflow-x-auto">
    <table class="w-full table-auto border-collapse">
        <thead>
            <tr>
                ...
                <th class="py-3 px-2 text-sm font-semibold text-gray-400 !md:w-[35%]">
                    <div class="h-5 bg-gray-300 rounded w-full animate-pulse"></div>
                </th>
                <th class="py-3 px-2 text-sm font-semibold text-gray-400 !text-center !md:w-[15%]">
                    <div class="h-5 bg-gray-300 rounded w-full animate-pulse"></div>
                </th>
        ...
        <tbody>
            @foreach (range(1, 10) as $i)
                <tr class="border-b border-gray-200">
                    ...
                    <td class="py-4 px-2 !md:w-[35%]">
                        <div class="h-6 bg-gray-300 rounded animate-pulse w-full"></div>
                    </td>
                    <td class="py-4 px-2 !text-center !md:w-[15%]">
                        <div class="h-6 bg-gray-300 rounded animate-pulse w-full"></div>
                    </td>
