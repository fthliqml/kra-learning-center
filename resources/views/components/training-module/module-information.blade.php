    ...
    <x-form wire:submit.prevent="saveDraft" no-separator>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <x-input label="Practical Passing Score (%)" type="number"
                wire:model.defer="formData.practical_passing_score" placeholder="75" class="focus-within:border-0"
                min="0" max="100" step="0.01" :error="$errors->first('formData.practical_passing_score')" />
        </div>
