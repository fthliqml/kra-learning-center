...
class ModulePretest extends Component
{
  ...
  {
    $this->dispatch('setTab', 'posttest');
  }

  public function goBack(): void
  {
    $this->dispatch('setTab', 'module-info');
  }
  ...
  public function saveDraft(): void
  {
    ...
    if (!$this->moduleId) {
      $this->error(
        'Save Module Information first to create the module before saving the Pretest.',
        timeout: 6000,
    ...
    $this->errorQuestionIndexes = [];
    $this->snapshot();
    $this->success('Pretest saved successfully!', timeout: 4000, position: 'toast-top toast-center');
  }
